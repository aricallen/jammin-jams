...
const WaitlistContent = withRouter(({ history, location }) => {
  ...
  return (
    <ContentWrapper>
      <Header1>
        Welcome to Jmn Jams! We are <Emphasis>so stoked</Emphasis> that you are here.
      </Header1>
      <Section>
        <Paragraph>
          We created Jmn Jams with the intent of celebrating all that is happy in life by doing what
          we love. Jam invites us to live in the present moment. We aim to transform the best
          seasonal fruits into sweet-tart-oh-so-tasty jam through the power of high heat and bass.
          At Jmn Jams, we firmly believe that fun and passion can be tasted. This is why we will
